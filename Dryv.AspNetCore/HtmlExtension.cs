...
namespace Dryv.AspNetCore
{
    public static class HtmlExtensions
    {
        ...
        public static IDictionary<string, Action<TextWriter>> GetDryvClientDisablingFunctions<TModel>(this IHtmlHelper<TModel> htmlHelper) => htmlHelper.GetDryvClientValidationLoader().GetDryvClientDisablingFunctions<TModel>();

        public static IDictionary<string, Action<TextWriter>> GetDryvClientDisablingFunctions<TModel>(this IHtmlHelper htmlHelper) => htmlHelper.GetDryvClientValidationLoader().GetDryvClientDisablingFunctions<TModel>();
        ...
        public static IDictionary<string, Action<TextWriter>> GetDryvClientValidationFunctions<TModel>(this IHtmlHelper<TModel> htmlHelper) => htmlHelper.GetDryvClientValidationLoader().GetDryvClientValidationFunctions<TModel>();

        public static IDictionary<string, Action<TextWriter>> GetDryvClientValidationFunctions<TModel>(this IHtmlHelper htmlHelper) => htmlHelper.GetDryvClientValidationLoader().GetDryvClientValidationFunctions<TModel>();
